				...
				<form class="infos nouveau" method="post" action="<?php echo site_url('accreditation/exeModifierGroupe'); ?>" enctype="multipart/form-data">
                   ...
                   <div class="inputs no-margin">
					...
					<div class="referent">
						...
						<div>
							<label>Image : </label>
							<input type="file" name="photo_file_<?php echo $ref->idclient; ?>"  />
						</div>
						<div>
							<label>Webcam : </label>
							<a href="<?php echo site_url('accreditation/voir/'.$ref->idclient); ?>" target="_blank">modifier via le profil</a>
						</div>
					...
					<?php foreach($personnes as $p): ?>
						...
						<div>
							<label>Image : </label>
							<input type="file" name="photo_file_<?php echo $p->idclient; ?>"  />
						</div>
						<div>
							<label>Webcam : </label>
							<a href="<?php echo site_url('accreditation/voir/'.$p->idclient); ?>" target="_blank">modifier via le profil</a>
						</div>
