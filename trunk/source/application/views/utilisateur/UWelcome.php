        ...
        <div id="main" class="nomargin">
			...
			<div class="intro">
				...
				<div class="desc">
					...
					<strong>préparer</strong> vos évènements, <strong>gérer</strong> vos accrédiations et <strong>générer</strong> vos
					pass.
					<br/><br>
				...
				<div class="suggestion">
					...
					<span class="alert">Attention, il ne vous reste que <?php echo floor(($evenement->datefin - time()) / 60 / 60 / 24); ?> jours pour valider vos demandes !</span>
					<?php endif; ?>
