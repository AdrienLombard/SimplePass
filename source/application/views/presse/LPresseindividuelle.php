...
<div class="wrap">
	...
	<form action="<?php echo site_url('presse/ajouter/'.$event_id.'/'.$categorie); ?>" method="POST" enctype="multipart/form-data">
		...
		<select  id="pays" name="pays" class="select">
		 ...
		 <div class="tel">
		    <label> Fixe </label>
			<input  type="text" value="<?php echo set_value('tel'); ?>" id="tel" name="tel_fixe" />
			<label> Portable* </label>
			<input  type="text" value="<?php echo set_value('tel'); ?>" id="tel" name="tel_portable" />
			<label> Ligne directe</label>
		    <input  type="text" value="<?php echo set_value('tel'); ?>" id="tel" name="tel_ligne_directe" />
		 </div>
