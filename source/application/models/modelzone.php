...
class modelZone extends MY_Model {
	...
	public function ajouterZonesAccreditation( $values ) {
		return $this->db->insert_batch(DB_ACCREDITATION_ZONES, $values);
	}
	...
	public function supprimerZoneParAccreditation ( $idAccred ) {
		return $this->db->delete(DB_ACCREDITATION_ZONES, array('idaccreditation' => $idAccred) );
	}
	
	public function supprimerZoneParZone ( $idzone ) {
		return $this->db->delete(DB_ACCREDITATION_ZONES, array('idzone' => $idzone) );
	}
